       ...
       # ================== Kachel 6 "Aufteilung Komplikationen CRS mit HIPEC ==================
        ...
        with col1.container(border=True):
            ...
            if required_cols.issubset(df_bereich.columns):
                ...
                df_plot = df_bereich[(df_bereich["malignit_t_sark"] == "Sarkom/Weichteiltumor") & (df_bereich["malignit_t_sark"] != "andere") & ((df_bereich["gruppen_chir_onko_sark"] != "Knochen") & (df_bereich["gruppen_chir_onko_sark"] != "Andere Malignome"))].copy()
